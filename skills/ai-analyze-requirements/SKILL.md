...
# SKILL.md - AI Analyze Requirements
...
- `standards/requirement-clarification-rules.md`

### Checklists
- `checklists/requirement-review-checklist.md`
...
### Shared Documents
- `checklists/clarification-rules.md`